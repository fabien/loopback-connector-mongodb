...
MongoDB.prototype.collectionName = function(model) {
  var options = this.collectionOptions(model);
 ...
 */
MongoDB.prototype.collectionOptions = function(model) {
...
MongoDB.prototype.collection = function(model, options) {
  ...
  var collectionName = this.collectionName(model, options);
...
MongoDB.prototype.execute = function(model, command, options) {
  var collection = this.collection(model, options);
...
function optimizedFindOrCreate(model, filter, data, options, callback) {
  ...
  this.collection(model, options).findOneAndUpdate(
    query,
    { $setOnInsert: data },
