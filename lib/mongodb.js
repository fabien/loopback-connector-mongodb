...
MongoDB.prototype.supportsTransactions = function(check) {
  ...
  return this.client && typeof this.client.startSession === 'function';
};
...
MongoDB.prototype.transaction = function(models, fn) {
  ...
  return new Promise(function(resolve, reject) {
    var transaction = new Transaction(self, resolve, reject);
...
Transaction.prototype.commit = function(cb) {
  if (this.isInTransation) {
    return endTransaction(this, this.session.commitTransaction(), cb).then(this.onCommit);
  } else {
    return Promise.resolve(false).then(this.onCommit);
  }
};
...
Transaction.prototype.rollback = function(cb) {
  ...
  if (this.isInTransation) {
    return endTransaction(this, this.session.abortTransaction(), cb).then(onRollback);
  } else {
    return Promise.resolve(false).then(onRollback);
  }
};
