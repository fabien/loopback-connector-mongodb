...
function wrapModel(modelBuilder, Model, fn) {
  ...
  Copy._observers = {};
  Object.keys(Model._observers).forEach(function(o) {
    if (Model._observers[o]) {
      Copy._observers[o] = [].concat(Model._observers[o]);
    }
  });
  Copy.observe('before save', fn);
  Copy.observe('before delete', fn);
  return Copy;
};
