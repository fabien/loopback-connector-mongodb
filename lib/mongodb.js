...
function withSession(model, command, options, args) {
  if (SESSION_COMMANDS.hasOwnProperty(command) &&
    ...
    options.transaction instanceof Transaction && options.transaction.isInTransation) {
...
Transaction.prototype.start = function(fn) {
  if (!this.isInTransation && this.isSupported) {
  ...
  if (typeof fn === 'function') {
    ...
    return Promise.resolve(this.isInTransation);
  }
};
